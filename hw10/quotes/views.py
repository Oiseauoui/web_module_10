...
def add_author(request):
    ...
    return render(request, 'authors/add_author.html', context={'author_form': author_form})
...
def author_list(request, author_id):
    ...
    return render(request, 'authors/authors.html', context={'author': author})
...
def quotes_by_tag(request, tag_name):
    ...
    return render(request, 'quotes/quotes_by_tag.html', {'quotes': quotes, 'authors': authors})
